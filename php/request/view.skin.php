...
<div>
	...
	<div class="media mb-4">
	<?php echo $board['bo_8_subj'] ?> : <?php echo $view['wr_8'] ?>
	</div>

	<div class="media mb-4">
	<?php echo $board['bo_9_subj'] ?> : <?php echo $view['wr_9'] ?>
	</div>

	<div class="media mb-4">
	<?php echo $board['bo_1_subj'] ?> : <?php echo $view['wr_1'] ?>
	</div>

	<div class="media mb-4">
	<?php echo $board['bo_2_subj'] ?> : <?php echo $view['wr_2'] ?>
	</div>

	<div class="media mb-4">
	<?php echo $board['bo_3_subj'] ?> : <?php echo $view['wr_3'] ?>
	</div>

	<div class="media mb-4">
	<?php echo $board['bo_4_subj'] ?> : <?php echo $view['wr_4'] ?>
	</div>

	<div class="media mb-4">
	<?php echo $board['bo_5_subj'] ?> : <?php echo $view['wr_5'] ?>-<?php echo $view['wr_6'] ?>-<?php echo $view['wr_7'] ?>
	</div>
