...
add_stylesheet('<link rel="stylesheet" href="'.$board_skin_url.'/style.css">', 999);
?>
...
<head>
  ...
  <style>
    ...
    @media screen and (max-width: 1100px) {
        .bo_pass .write_div{display:block; float:none !important; width: 100% !important;}
        .bo_pass .write_div:nth-of-type(2){text-align:left !important;}

    }
    @media screen and (max-width: 787px) {
        
       .bo_header{height:100px ; margin-top:100px;}
        .bo_header h1{font-size:30px !important; line-height:100px;}

        #board_title h1{font-size:26px !important;}
        #board_title p{font-size:14px !important;}
        .write_div_input{height: 70px !important; font-size:14px !important;}
        .write_div_input h2{font-size:16px !important; line-height:35px !important;}
        #bo_w .bo_w_info .frm_input{height: 35px  !important; width: 40%  !important; } 

        .bo_w_tit h2{font-size:16px !important;}
        .half_input{width: 50% !important;}
...
<!-- 게시판 맨 위 제목 -->
<div class="bo_header">
    <h1 tyle="font-family: JS Arirang HON;">가맹문의</h1>
</div>
